  ...
  return (
    <section id="testimonials" className="relative bg-[#000000] w-full min-h-[100dvh] pt-24 md:pt-48 pb-20 md:pb-32 overflow-clip flex flex-col justify-center border-t border-white/5">
      ...
      <div className="relative w-full py-10 md:py-16 flex items-center bg-[#050505] border-y border-white/5 overflow-hidden group">
        ...
        <div className="flex gap-4 md:gap-8 px-4 animate-marquee group-hover:[animation-play-state:paused] group-hover:scale-[0.98] transition-transform duration-1000 w-max select-none">
          {duplicatedTestimonials.map((t, i) => (
            <div 
              key={i} 
              className="w-[300px] md:w-[450px] shrink-0 p-8 md:p-12 bg-white/5 border border-white/10 hover:border-[#bf00ff]/50 hover:bg-white/10 rounded-[2rem] backdrop-blur-3xl transition-all duration-300 flex flex-col justify-between gap-8 md:gap-12 hover:-translate-y-2 cursor-default"
            >
